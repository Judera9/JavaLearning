...
public class GraphTest {
    ...
    public void test01() throws IOException {
        ...
        graph.readGraphFile("C:\\Users\\Jude\\Learning\\Coding\\JavaLearning\\Homework\\src\\Ass4\\problem2\\test\\graph1.txt");
        System.out.print(graph.printAdjacencyMatrix());
        assertEquals("0 0 0 3 6 0 0 0 \n" +
                "0 0 2 0 0 4 0 0 \n" +
                "0 0 0 0 0 5 9 0 \n" +
                "0 0 0 0 0 0 0 5 \n" +
                "0 0 0 0 0 0 9 0 \n" +
    ...
    public void test02() throws IOException {
        Graph graph = new Graph();
        graph.readGraphFile("C:\\Users\\Jude\\Learning\\Coding\\JavaLearning\\Homework\\src\\Ass4\\problem2\\test\\graph2.txt");
        System.out.print(graph.printAdjacencyMatrix());
